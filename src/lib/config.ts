...
export const PLAYER_MECH = "GUNDAM";
...
export const WAKE_WORDS = [
  "gundam", "gun dam", "gundum", "gandam", "gondam", "gundham", "gun damn", "gun down",
  "gundam system", "gundam start", "gundam wake up",
  // ECHO-01 is still the co-pilot's name, so calling it also wakes the machine.
 ...
 *  G.U.N.D.A.M. — General Unilateral Neuro-link Dispersive Autonomic Maneuver. */
export const BOOT_LETTERS = [
  { letter: "G", word: "GENERAL", system: "TACTICAL CORE" },
  { letter: "U", word: "UNILATERAL", system: "WEAPON SYSTEM" },
  { letter: "N", word: "NEURO-LINK", system: "NEURAL LINK" },
  { letter: "D", word: "DISPERSIVE", system: "RADAR" },
  { letter: "A", word: "AUTONOMIC", system: "AUTONOMOUS CONTROL" },
  { letter: "M", word: "MANEUVER", system: "MOBILITY SYSTEM" },
] as const;
